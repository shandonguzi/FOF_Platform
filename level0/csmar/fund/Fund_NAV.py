...
def get_page(driver):
    ...
    driver.find_elements(By.XPATH, '//*[contains(text(), "基金表现")]')[0].click()
    time.sleep(SLEEP_TIME)

    driver.find_elements(By.XPATH, '//*[contains(text(), "基金日净值文件")]')[0].click()
    time.sleep(SLEEP_TIME)

    driver.find_elements(By.XPATH, '//*[contains(text(), "基金份额净值")]')[0].click()
    time.sleep(SLEEP_TIME)
